# Streaming ML Scoring (Local PySpark)

This module implements roadmap Step 3 using local PySpark (no Spark cluster / Docker for Spark).
...
- Writes scored data to data lake paths.
...
- Scored and alert records are also written locally by default:
